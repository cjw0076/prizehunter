...
EXTRA: dict[str, dict[str, str]] = {
    "236722": {
        "name": "SKKU Multimodal AI Bias Challenge",
        "official": "https://dacon.io/en/competitions/official/236722/overview/description",
        "project": "DACON leaderboard submission",
        "repo": "-",
        "demo": "-",
        "video": "-",
        "check": "Check DACON submissions/leaderboard for live best 0.9995; candidate_queue_236722.csv marks the best submitted file and rank-1 gap.",
        "evidence": "aibias/candidate_queue_236722.csv; aibias/ledger_236722.md",
    },
    "236690": {
        "name": "ETRI Human Understanding AI Paper Challenge",
        "official": "https://dacon.io/en/competitions/official/236690/overview/description",
        "project": "DACON leaderboard submission",
        "repo": "-",
        "demo": "-",
        "video": "-",
        "check": "Check DACON submissions/leaderboard and the ETRI submission receipts; current registry separates public best from private pick.",
        "evidence": "etri/artifacts/dacon_submit_*.json; etri/docs/AGENT_WORKLOG.md",
    },
    "rapid": {
        "name": "RuleMemory Cloud",
        "official": "https://rapid-agent.devpost.com/",
        "project": "https://devpost.com/software/rulememory-cloud",
        "repo": "https://github.com/cjw0076/rulememory-cloud",
        "demo": "https://rulememory-cloud-516399822756.us-central1.run.app",
        "video": "https://github.com/cjw0076/rulememory-cloud/releases/download/demo-v1/rulememory_cloud_demo.mp4",
        "check": "Open Devpost project/manage page and confirm `SUBMITTED` for RuleMemory Cloud; `hackathon ENDED` only means the submit window closed after submission.",
        "evidence": "/tmp/devpost_current_verify/rapid_manage.png; competitions/rapid_agent_2026/docs/AGENT_WORKLOG.md",
    },
    "find-evil": {
        "name": "EvidenceGuard SIFT / FIND EVIL",
        "official": "https://findevil.devpost.com/",
        "project": "https://devpost.com/software/evidenceguard-sift",
        "repo": "https://github.com/cjw0076/find-evil-dfir-agent",
        "demo": "-",
        "video": "https://github.com/cjw0076/find-evil-dfir-agent/releases/download/demo-v1/find_evil_demo.mp4",
        "check": "Open the public project page or Devpost manage page and confirm the FIND EVIL submission; do not confuse it with any separate draft.",
        "evidence": "/tmp/devpost_current_verify/find_evil_manage.png; competitions/find_evil_2026/docs/AGENT_WORKLOG.md",
    },
    "ai-case": {
        "name": "AI Case Contest submission",
        "official": "https://ai.software.kr/",
        "project": "(portal completion page; session required)",
        "repo": "-",
        "demo": "-",
        "video": "-",
        "check": "Portal completion page reached at ai.software.kr/contest/apply/complete with PDF attachment; monitor result email/notice.",
        "evidence": "/tmp/ai_case_04_after_submit.png; competitions/control_tower/receipts/20260613T044000+0900_ai-case-portal-submitted.md",
    },
    "uipath": {
        "name": "Competition Command Tower",
        "official": "https://uipath-agenthack.devpost.com/",
        "project": "https://devpost.com/software/uriagent",
        "repo": "https://github.com/cjw0076/uipath-command-tower",
        "demo": "https://cjw0076.github.io/uipath-command-tower/",
        "video": "https://youtu.be/g8fEB-X1hiI",
        "check": "Open Devpost project page and confirm submitted project title `Competition Command Tower` / software slug `uriagent`.",
        "evidence": "competitions/control_tower/receipts/20260613T142423+0900_uipath-devpost-submitted-20260613.md; competitions/uipath_agenthack_2026/docs/AGENT_WORKLOG.md",
    },
    "splunk": {
        "name": "Splunk Agentic Ops — Incident Copilot",
        "official": "https://splunk.devpost.com/",
        "project": "(not recorded; use Devpost manage page)",
        "repo": "https://github.com/cjw0076/splunk-agentic-ops-copilot",
        "demo": "-",
        "video": "https://github.com/cjw0076/splunk-agentic-ops-copilot/releases/download/demo-v1/splunk_copilot_demo.mp4",
        "check": "Open Devpost manage page and confirm the target project, not a separate draft, shows `SUBMITTED`.",
        "evidence": "/tmp/devpost_current_verify/splunk_manage.png; competitions/splunk_agentic_ops_2026/docs/AGENT_WORKLOG.md",
    },
    "orbit-wars": {
        "name": "Orbit Wars Kaggle bot",
        "official": "https://www.kaggle.com/competitions/orbit-wars",
        "project": "Kaggle submission refs: v7=53585553, v10=53606179, v12=53630504",
        "repo": "-",
        "demo": "-",
        "video": "-",
        "check": "Run `kaggle competitions submissions -c orbit-wars`; best live remains v7 publicScore 680.0, v12 was submitted but scored lower.",
        "evidence": "competitions/control_tower/campaigns/orbit-wars/WORKLOG.md; competitions/control_tower/receipts/20260613T171305+0900_orbit-wars-v12-kaggle-submit-20260613.md",
    },
    "arc-whitebox-2026": {
        "name": "ARC White-Box Estimation Challenge 2026",
        "official": "https://www.aicrowd.com/challenges/arc-white-box-estimation-challenge-2026",
        "project": "AIcrowd submission id 310770",
        "repo": "-",
        "demo": "-",
        "video": "-",
        "check": "Open the AIcrowd challenge submissions page or use the AIcrowd account UI to monitor submission id 310770; local JSON says Submission accepted.",
        "evidence": "competitions/control_tower/campaigns/arc-whitebox-2026/whest_submit_latest.json; competitions/control_tower/campaigns/arc-whitebox-2026/WORKLOG.md",
    },
    "moct": {
        "name": "문화 처방 AI 대시보드",
        "official": "https://www.culture.go.kr/digicon/pages/contest_3.do",
        "project": "culture.go.kr receipt lookup",
        "repo": "-",
        "demo": "-",
        "video": "-",
        "check": "Use the 접수확인 page with team mode and founder identity fields. Do not store or print the phone/password values.",
        "evidence": "/tmp/moct_verify_current3/result.png; competitions/control_tower/receipts/20260613T190613+0900_moct-portal-receipt-reverified-20260613.md",
    },
    "qwen": {
        "name": "Qwen RuleMemory Agent",
        "official": "https://qwencloud-hackathon.devpost.com/",
        "project": "(Devpost confirmation email received; public slug not captured)",
        "repo": "https://github.com/cjw0076/rulememory-qwen-agent",
        "demo": "-",
        "video": "https://youtu.be/r7dl2qs1vlI",
        "check": "Gmail Devpost confirmation message `19eaef861d1144b0` confirms submitted; absence of a captured public slug must not be treated as not-submitted.",
        "evidence": "Gmail message 19eaef861d1144b0; competitions/control_tower/receipts/20260615T225941+0900_qwen-devpost-submission-confirmation-20260615.md; competitions/qwen_cloud_hackathon_2026/docs/AGENT_WORKLOG.md",
    },
}
...
KNOWN_STATUS_CONFLICTS = [
    {
        "key": "qwen",
        "current": "submitted in portfolio_registry.tsv",
        "conflict": "older /tmp Devpost draft screenshots and stale generated reports said blocked before Gmail confirmation.",
        "rule": "Trust Gmail confirmation message 19eaef861d1144b0 plus the current registry; regenerate stale reports from portfolio_registry.tsv.",
    },
    {
        "key": "orbit-wars",
        "current": "ceiling in portfolio_registry.tsv; Kaggle submission evidence preserved in worklog/receipts",
        "conflict": "older EXIT/SALE_DOSSIER.md row described v12 as ready-gate before later submit/score checks.",
        "rule": "Trust campaigns/orbit-wars/WORKLOG.md 2026-06-13 submit + 2026-06-15 live score audit; submitted/scored is not rank-1 completion.",
    },
    {
        "key": "rapid/find-evil/splunk",
        "current": "submitted in portfolio_registry.tsv",
        "conflict": "CONDUCTOR_GROUND_TRUTH_SUBMISSIONS.md contains initial negative rows that are explicitly retracted later in the same file.",
        "rule": "Trust the retraction plus current registry; do not infer not-submitted from `hackathon ENDED` alone.",
    },
]
